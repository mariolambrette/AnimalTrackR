  ...
  for gr in names:
    ...
    for vid in vids[gr]:
      ...
      if os.path.isdir(vid):
        ...
        # Iterate over unique video id's in select frames to extract selected frames
        ...
        if os.path.isfile(vid):
          ...
          if f_ext.lower() not in exts:
            raise ValueError("Video format incompatible. Check file path and adjust `vid_ext` if neccesary")
        else:
