...
`AnimalTrackR` relies on python to execute image processing tasks. Specifically, it uses a python 3.9 conda environment. When you first install the package you will need to run the following command to create the environment:
